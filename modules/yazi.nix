...
in
{
  programs.yazi = {
    ...
    theme = {
      ...
      icon = {
        prepend_dirs = [
          { name = "Downloads"; text = ""; fg = "#f7768e"; }
          { name = "Documents"; text = ""; fg = "#9ece6a"; }
          { name = "Pictures";  text = ""; fg = "#bb9af7"; }
          { name = "Videos";    text = ""; fg = "#e0af68"; }
        ];
      };
      ...
      filetype = {
        rules = [
          { mime = "image/*";        fg = "#f5a97f"; }
          { mime = "video/*";        fg = "#e0af68"; }
          { mime = "audio/*";        fg = "#9ece6a"; }
          { mime = "text/x-python";  fg = "#9ece6a"; }
          { mime = "text/x-go";      fg = "#7aa2f7"; }
          { mime = "text/x-c";       fg = "#bb9af7"; }
          { mime = "application/zip"; fg = "#f7768e"; }
          { name = "*/";             fg = "#7dcfff"; } # directories fallback
        ];
      };
    };
  };
